...
const Profile = () => {
    ...
    //Retrieve the user object from local storage and display the username
    const currentUser = JSON.parse(localStorage.getItem('currentUser'));

    //Get the current user's posts from posts.json
    //Iterate through each post to display only the current user's posts in their profile
